...
ggsave("tuskegee_airmen.png",width = 297,height = 210,units = c("mm"),dpi = 300)

ggsave(tuskegee_airmen, file = "tuskegee_airmen.png", width = 22, height = 28, dpi = 150, units = "in")

ggsave("tuskegee_airmen.png",tuskegee_airmen)
